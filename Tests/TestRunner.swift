...
struct TestMain {
    ...
    static func main() async {
        ...
        testLyricPanelFadeStops()
        testSummaryMarqueeMetrics()
        testPlaybackInterpolation()
        testAccessibilityPlaybackStateDoesNotOverwriteWhenUnknown()
        testAccessibilityProgressDoesNotMovePlaybackClock()
        testAccessibilityButtonStateInference()
